...
The two remaining prototypes, the Finger rigid hands and the Rotation hands, both use the methods mentioned above to achieve their position filtering. The Finger rigid hands use the exact same position filtering method as the Rigid hands and the Rotation hands use a filter similar to the Sliding rigid hands with the exception that it doesn't do any depenetration.
...
\begin{tabular}{C{2.8cm}|C{2cm}C{2cm}C{2cm}C{2cm}C{2cm}}
 & Rigid hands & Sliding rigid hands & Finger rigid hands & Physics hands & Rotation hands \\ \midrule
